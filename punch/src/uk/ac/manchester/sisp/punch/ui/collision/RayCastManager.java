...
public class RayCastManager <U extends IVec2.I & IDim2.I> {
	...
	public static final <U extends IVec2> U onFetchParent(final List<U> pHierarchy, final U pChild) {
		...
		return (lIndex >= 0) ? pHierarchy.get(lIndex) : null;
	}
	...
	public final boolean isIntersectingBounds(final U pU) {
		...
		final float lX1 = lX0 + ((pU.getWidth() ));
		final float lY1 = lY0 + ((pU.getHeight()));
	...
	public final void onRayHierarchyTransform(final IVec2.I pVec2) {
		/* Declare the Initial Coefficients. */
		this.setCollisionX(pVec2.getX());
		this.setCollisionY(pVec2.getY());
	...
	public final List<U> getCollisionResults() {
